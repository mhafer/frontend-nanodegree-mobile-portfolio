...
var resizePizzas = function(size) {
  ...
  //removed  determine dx as it was preformance minimizing
...
// Move randomPizzas variable out of for loop
  var randomPizzas = document.getElementsByClassName("randomPizzaContainer");

// get the length (number of elements)
    var pizzaLength = randomPizzas.length

//loop through elements and resize their widths
...
function updatePositions() {
  ...
  var top = document.body.scrollTop / 1250;   //removed query select all from loop
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzasContainer = document.querySelector("#movingPizzas1"); //removed from loop
